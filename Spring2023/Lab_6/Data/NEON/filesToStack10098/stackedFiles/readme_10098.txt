...
Sensor(s): 
Keywords: saplings, productivity, canopy height, vegetation structure, shrubs, carbon cycle, vegetation, biomass, plants, lianas, plant productivity, tree height, annual net primary productivity (ANPP), production, woody plants, vst, net primary productivity (NPP), trees
Domain: D01
DATA PACKAGE CONTENTS
---------------------
This folder contains the following documentation files:
This data product contains up to 5 data tables:
- Term descriptions, data types, and units: NEON.D01.HARV.DP1.10098.001.variables.20230418T030944Z.csv
