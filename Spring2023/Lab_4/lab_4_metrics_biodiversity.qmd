...
Save raw data in your hard drive - this is a common practice that allow reproducibility and also save you a lot of time.
...
Now we can select some specific columns that we will use from now on.
