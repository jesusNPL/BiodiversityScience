...
As a last step let's transform the **pixel_df** data frame to a format that {ggplot2} like.
...
By inspecting the plot we can confirm that the sections of the spectra with anomalies are within the atmospheric absortion bands. Using the absorption band limits we can remove the sections with anomalies and plot masked spectral signatures for the five spatial points.
