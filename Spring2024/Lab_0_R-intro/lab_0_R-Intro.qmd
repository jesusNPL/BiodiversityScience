...
Get student names from the roster 2024
...
for (i in 1:length(Student_names)){ 
  ...
  print(paste0("Hi ", Student_names[i], 
               ", welcome to the first practice of Biodiversity Science 2024!"))
