...
Moreover, as more than three years have passed since the pandemic started, the variability in the number of cases is huge, so let's select the first ~45 days of cases to fit our model and then use the fitted model to predict the dynamics of COVID-19 for the following year.
